      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 py-20">
        ...
        <div className="bg-gray-900 rounded-2xl border border-gray-800 p-8 sm:p-12">
          <div className="flex items-center mb-8">
            <HelpCircle className="w-8 h-8 text-blue-400 mr-4" />
          ...
          <div className="mb-6">
            ...
            >
              <div className="flex items-center">
                ...
                <span className="text-lg font-semibold text-white">ログイン方法</span>
              </div>
              {openSection === 'login' ? (
              ...
              <div className="mt-4 p-6 bg-gray-800/50 rounded-xl">
                <ol className="space-y-4 text-gray-300">
                  <li className="flex items-start">
                    <span className="flex-shrink-0 w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold mr-3 mt-0.5">
                      1
                    </span>
                    <div>
                      <p className="font-medium text-white mb-1">Utageの会員ページにアクセス</p>
                      <p className="text-sm text-gray-400">Utageの会員ページからSendRightにアクセスしてください。</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="flex-shrink-0 w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold mr-3 mt-0.5">
                    ...
                    <div>
                      <p className="font-medium text-white mb-1">SendRightにログイン</p>
                      <p className="text-sm text-gray-400">会員ページからSendRightのリンクをクリックすると、自動的にログインされます。</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="flex-shrink-0 w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold mr-3 mt-0.5">
                    ...
                    <div>
                      <p className="font-medium text-white mb-1">URLから直接アクセス可能</p>
                      <p className="text-sm text-gray-400">ログイン後は、SendRightのURLに直接アクセスして使用できます。セッションは1日間有効です。</p>
                    </div>
                  </li>
                </ol>
          ...
          <div className="mb-6">
            ...
            >
              <div className="flex items-center">
                ...
                <span className="text-lg font-semibold text-white">メッセージの入力方法</span>
              </div>
              {openSection === 'input' ? (
                <ChevronUp className="w-5 h-5 text-gray-400" />
              ) : (
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="font-semibold text-white mb-2 flex items-center">
                      <span className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold mr-3 text-sm">
                        1
                      </span>
                      テキスト入力
                    </h3>
                    <p className="text-gray-300 ml-11">メッセージ入力欄に直接テキストを入力します。最も基本的な方法です。</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-white mb-2 flex items-center">
                    ...
                    <p className="text-gray-300 ml-8">マイクボタンをクリックして、音声でメッセージを入力します。Chrome、Edge、Safariで利用可能です。</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-white mb-2 flex items-center">
                      <ImageIcon className="w-5 h-5 text-blue-400 mr-3" />
                      画像アップロード
                    </h3>
                    <p className="text-gray-300 ml-8">LINEやDMのスクリーンショットをアップロードすると、自動的にメッセージが抽出されます。会話全体の文脈も考慮されます。</p>
                    <div className="mt-3 ml-8 p-3 bg-gray-900 rounded-lg">
          ...
          <div className="mb-6">
            ...
            >
              <div className="flex items-center">
                <User className="w-5 h-5 text-blue-400 mr-3" />
                <span className="text-lg font-semibold text-white">パーソナライズ設定</span>
              </div>
              ...
              <div className="mt-4 p-6 bg-gray-800/50 rounded-xl">
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-gray-900 rounded-lg">
                    <p className="text-sm font-medium text-white mb-1">設定できる項目</p>
          ...
          <div className="mb-6">
            ...
            >
              <div className="flex items-center">
                <Copy className="w-5 h-5 text-blue-400 mr-3" />
                <span className="text-lg font-semibold text-white">返信の使い方</span>
              </div>
            ...
            {openSection === 'response' && (
              <div className="mt-4 p-6 bg-gray-800/50 rounded-xl">
                <div className="space-y-4">
                  <div>
                    <h3 className="font-semibold text-white mb-2">3つの返信候補</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-white mb-2">評価機能</h3>
                    <p className="text-gray-300 text-sm">
          ...
          <div className="mb-6">
            ...
            {openSection === 'faq' && (
              <div className="mt-4 p-6 bg-gray-800/50 rounded-xl space-y-4">
                <div>
                  <h3 className="font-semibold text-white mb-2">Q: 使用回数制限はありますか？</h3>
                  ...
                  <ul className="text-gray-300 text-sm ml-4 mt-2 space-y-1">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-2">Q: セッションが切れた場合はどうすればいいですか？</h3>
                  <p className="text-gray-300 text-sm">
                    A: Utageの会員ページから再度SendRightにアクセスしてください。セッションは1日間有効です。
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-white mb-2">Q: 音声入力が使えません</h3>
                  <p className="text-gray-300 text-sm">
                    A: 音声入力はChrome、Edge、Safariで利用可能です。マイクの使用許可が必要です。ブラウザの設定でマイクへのアクセスを許可してください。
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-white mb-2">Q: 画像からテキストが抽出できません</h3>
                  <p className="text-gray-300 text-sm">
